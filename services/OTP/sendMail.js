              ...
              <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                  ...
                  <div class="u-row-container" style="padding: 0px;background-color: transparent">
                    <div class="u-row"
                      style="Margin: 0 auto;min-width: 320px;max-width: 650px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: black;">
                                      ...
                                      <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                          <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                            ...
                                            <img align="center" border="0" src="https://res.cloudinary.com/das1ctdt6/image/upload/v1657794576/logo_x8fdsz.png" alt="Image" title="Image"
                                              style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 20%;max-width: 117px;"
                                              width="117" />
                                    ...
                                    <td
                                      ...
                                      <div style="color: #018eea; line-height: 170%; text-align: left; word-wrap: break-word;">
                                        <p style="line-height: 170%; text-align: center; font-size: 14px;"><span
                                            style="font-size: 24px; line-height: 40.8px; color: white;"><strong> 
                                                &nbsp; F O R G E T &nbsp; P A S S W O R D!</strong></span></p>
                                        <p style="font-size: 14px; line-height: 170%; text-align: center;"><span
                                            style="font-size: 16px; line-height: 27.2px; color: #000000;">&nbsp;&nbsp;</span>
                                        </p>
                                      </div>
                                  ...
                                  <tr>
                                    <td
                                      ...
                                      <div
                                        ...
                                        <p style="font-size: 14px; line-height: 140%;">Your One Time OTP to Forget Password in to your DexWin account is <b>${OTP}</b>.The OTP is valid for 5 minutes. This OTP will be used to verify . For account safety, Do not share your OTP with others.
                                       <br><br><br>    
                                    ...
                                    <td
                                      ...
                                      <div
                                        ...
                                        <p style="font-size: 14px; line-height: 140%;"><span
                                            style="font-size: 14px; line-height: 19.6px;">2022 @DexWin| All Rights
                                            Reserved</span></p>
                                      </div>
