...
const sendmail = (email ,fname) => {
                                  ...
                                  <td
                                    ...
                                    <div style="color: #018eea; line-height: 170%; text-align: left; word-wrap: break-word;">
                                      <p style="line-height: 170%; text-align: center; font-size: 14px;"><span
                                          style="font-size: 24px; line-height: 40.8px; color: white;"><strong>T H A N K S
                                            &nbsp; F O R &nbsp; S I G N I N G &nbsp; U P !</strong></span></p>
                                ...
                                <tr>
                                  <td
                                    ...
                                    <div
                                      ...
                                      <p style="font-size: 14px; line-height: 140%;">Hi ${fname}</p>
                                      <p style="font-size: 14px; line-height: 140%;">Welcome to <b>DexWin.</b> Your are Sign
                                        Up succesfully
    ...
    transport.sendMail(mailOptions).then((data) => {
